...
const {monthlyPayment ,totalPaid, totalInterest} = useMonthlyPayment(props.listing.data.price, interestRate, duration)
</script>
  ...
  <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    ...
    <div class="md:col-span-5 flex flex-col gap-4">
      <Box>
        ...
        <Price :price="listing.data.price" class="text-2xl font-bold" />
        <ListingSpace :listing="listing.data" class="text-lg" />
        <ListingAddress :listing="listing.data" class="text-gray-500" />
      </Box>
